  ...
  return (
    <footer className="relative py-12 dark:border-gray-800 overflow-hidden bg-gray-50 dark:bg-gray-900">
      ...
      <div className="container relative z-10 mx-auto px-4">
        {/* Main footer content - restructured for better large screen layout */}
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          {/* Company Info Section - takes 4 columns on large screens */}
          <div className="md:col-span-4">
            <div className="flex flex-col items-center md:items-start">
              <h3 className="text-2xl font-bold text-yellow-500 dark:text-yellow-400 mb-4 relative group">
                <div className="relative flex flex-col z-10 justify-center items-center md:items-start transform transition-transform duration-300 group-hover:translate-x-1">
                  <TopDecoration />
              ...
              <p className="text-gray-700 dark:text-gray-300 text-center md:text-left mb-6 leading-relaxed">
              ...
              {/* Social Media Icons - always visible on large screens, hidden on mobile */}
              <div className="lg:flex hidden space-x-6 mt-4">
                {[
                  {
                    name: 'Twitter',
          ...
          <div className="md:col-span-4">
            <div className="p-6 rounded-lg transition-all duration-300">
              ...
              <div className="flex mt-6 justify-center items-center md:hidden gap-4">
                {[
                  {
                    name: 'Twitter',
                    icon: 'M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z',
