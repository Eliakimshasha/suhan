...
export default function Header() {
  ...
  return (
    <header className="fixed w-full top-0 z-50 bg-transparent dark:bg-transparent backdrop-blur-sm">
      <nav className="container mx-auto px-4 py-2 lg:py-4 flex items-center justify-between">
        <motion.div
          initial={{ opacity: 0, x: -20 }}
          animate={{ opacity: 1, x: 0 }}
          className="text-2xl font-bold text-yellow-400"
        >
          <div className="w-[150px] h-[80px] relative overflow-hidden flex justify-center items-center">
            <Image
              src={Logo}
              width={100}
              alt="SC"
