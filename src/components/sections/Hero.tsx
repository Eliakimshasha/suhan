  ...
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-yellow-100 to-blue-200 dark:from-yellow-900 dark:to-gray-800">
        ...
        >
          ...
          <Button className="bg-yellow-400 hover:bg-yellow-500 text-white px-8 py-3 mb-9 rounded-full text-lg font-semibold transition-all duration-300 hover:scale-105">
            Get in Touch
          </Button>
        </motion.div>
      </div>
